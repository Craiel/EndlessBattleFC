declare("BaseGame", function () {
    ...
    function Game() {
        ...
        this.StatUpgrade = function(type, amount) {
            this.type = type;
            this.amount = amount;
        }

        this.StatUpgradesManager = function() {
        ...
        /* ========== ========== ========== ========== ==========  ========== ========== ========== ========== ==========  /
         /                                                    MERCENARIES                                                       
         /  ========== ========== ========== ========== ==========  ========== ========== ========== ========== ========== */
        this.mercenary = function(type) {
            this.type = type;
        }

        this.mercenaryManager = function() {
        ...
        /* ========== ========== ========== ========== ==========  ========== ========== ========== ========== ==========  /
         /                                                      QUESTS                                                       
         /  ========== ========== ========== ========== ==========  ========== ========== ========== ========== ========== */
        this.Quest = function(name, description, type, typeId, typeAmount, goldReward, expReward, buffReward) {
            this.name = name;
        ...
        /* ========== ========== ========== ========== ==========  ========== ========== ========== ========== ==========  /
         /                                                       BUFFS                                                       
         /  ========== ========== ========== ========== ==========  ========== ========== ========== ========== ========== */
        this.Buff = function(name, type, multiplier, duration, leftPos, topPos) {
            this.id = null;
            this.name = name;
            this.type = type;
            ...
            this.getRandomQuestRewardBuff = function getRandomQuestRewardBuff() {
                switch (Math.floor(Math.random() * 9)) {
                    case 0:
                        ...
                        break;
                    case 1:
                        return new Buff("Damage x4", BuffType.DAMAGE, 4, 60, 30, 0);
                        break;
                    case 2:
                        return new Buff("Damage x7", BuffType.DAMAGE, 7, 60, 15, 0);
                        break;
                    case 3:
                        return new Buff("Gold x2", BuffType.GOLD, 2, 60, 0, 30);
                        break;
                    case 4:
                        return new Buff("Gold x4", BuffType.GOLD, 4, 60, 30, 30);
                        break;
                    case 5:
                        return new Buff("Gold x7", BuffType.GOLD, 7, 60, 15, 30);
                        break;
                    case 6:
                        return new Buff("Experience x2", BuffType.EXPERIENCE, 2, 60, 0, 15);
                        break;
                    case 7:
                        return new Buff("Experience x4", BuffType.EXPERIENCE, 4, 60, 30, 15);
                        break;
                    case 8:
                        return new Buff("Experience x7", BuffType.EXPERIENCE, 7, 60, 15, 15);
                        break;
                }
            }
        }
        ...
        /* ========== ========== ========== ========== ==========  ========== ========== ========== ========== ==========  /
         ...
         /  ========== ========== ========== ========== ==========  ========== ========== ========== ========== ========== */
        // duration in ms
        this.Particle = function(image, text, textColour, x, y, width, height, velocityX, velocityY, duration) {
            this.image = image;
            this.text = text;
        ...
        this.Effect = function(type, chance, value) {
            this.type = type;
            this.chance = chance;
            this.value = value;
        ...
        this.Item = function(name, level, rarity, type, sellValue, iconSourceX, iconSourceY, itemBonuses) {
            this.name = name;
            this.level = level;
            this.rarity = rarity;
            this.type = type;
        ...
        /* ========== ========== ========== ========== ==========  ========== ========== ========== ========== ==========  /
         /                                                     UPGRADES                                                       
         /  ========== ========== ========== ========== ==========  ========== ========== ========== ========== ========== */
        this.Upgrade = function(name, cost, type, requirementType, requirementAmount, description, iconSourceLeft, iconSourceTop) {
            this.name = name;
            this.cost = cost;
            this.type = type;
