declare('TooltipManager', function () {
    ...
    TooltipManager.prototype = component.prototype();
    ...
    TooltipManager.prototype.displayItemTooltip = function(item1, item2, item3, left, top, canSell) {
        // Get the item type
        var type = '';
        switch (item1.type) {
    ...
    TooltipManager.prototype.displayBasicTooltip = function(obj, text) {
