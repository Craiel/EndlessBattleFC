declare('QuestManager', function () {
    ...
    QuestManager.prototype = component.prototype();
    ...
    QuestManager.prototype.addQuest = function(quest) {
    ...
    QuestManager.prototype.componentUpdate = QuestManager.prototype.update;
    QuestManager.prototype.update = function(gameTime) {
    ...
    QuestManager.prototype.stopGlowingQuestsButton = function() {
    ...
    QuestManager.prototype.updateKillCounts = function(level) {
    ...
    QuestManager.prototype.removeQuest = function(id) {
    ...
    QuestManager.prototype.getSelectedQuest = function() {
    ...
    QuestManager.prototype.createQuest = function(name, description, type, typeId, typeAmount, goldReward, expReward, buffReward)
    {
    ...
    QuestManager.prototype.save = function() {
