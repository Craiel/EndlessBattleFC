declare('BuffSet', function () {
    ...
    BuffSet.prototype.addBuff = function(buff) {
    ...
    BuffSet.prototype.getDamageMultiplier = function() {
        var multiplier = 0;
    ...
    BuffSet.prototype.getGoldMultiplier = function() {
        var multiplier = 0;
        for (var x = 0; x < this.buffs.length; x++) {
    ...
    BuffSet.prototype.getExperienceMultiplier = function() {
        var multiplier = 0;
        for (var x = 0; x < this.buffs.length; x++) {
    ...
    BuffSet.prototype.update = function(gameTime) {
    ...
    BuffSet.prototype.getRandomQuestRewardBuff = function() {
