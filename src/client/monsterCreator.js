declare('MonsterCreator', function () {
    ...
    MonsterCreator.prototype = component.prototype();
    ...
    MonsterCreator.prototype.createRandomMonster = function(level, rarity) {
    ...
    MonsterCreator.prototype.calculateMonsterHealth = function(level, rarity) {
    ...
    MonsterCreator.prototype.calculateMonsterDamage = function(level, rarity) {
    ...
    MonsterCreator.prototype.calculateMonsterGoldWorth = function(level, rarity) {
    ...
    MonsterCreator.prototype.calculateMonsterExperienceWorth = function(level, rarity) {
    ...
    MonsterCreator.prototype.calculateMonsterRarity = function(battleLevel, battleDepth) {
