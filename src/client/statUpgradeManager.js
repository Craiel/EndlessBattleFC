declare('StatUpgradeManager', function () {
    ...
    StatUpgradeManager.prototype = component.prototype();
    ...
    StatUpgradeManager.prototype.addNewUpgrades = function(upgrade1Type, upgrade1Amount, upgrade2Type, upgrade2Amount, upgrade3Type, upgrade3Amount) {
    ...
    StatUpgradeManager.prototype.addRandomUpgrades = function(level) {
