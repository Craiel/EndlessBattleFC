function FrozenBattle() {
    ...
    this.registerHooks = function() {
        ...
        game.native_update = game.update;
    ...
    this.onCreateMonster = function(level, rarity) {
        ...
        newMonster.takeDamage = game.FrozenBattle.onMonsterTakeDamage;
    ...
    this.onUpdate = function() {
        game.FrozenBattle.update();
    }

    this.onSave = function() {
        game.FrozenBattle.save();
    }

    this.onLoad = function() {
        game.FrozenBattle.load();
    }
    ...
    this.getAutoAttackTime = function() {
        ...
        deduction += game.mercenaryManager.assassinsOwned * 150;
    ...
    this.onCreateRandomItem = function(level, rarity) {
        return game.FrozenBattle.createRandomItem(level, rarity);
    }
    ...
    this.initializeUI = function() {
        ...
        $('#fbOptionNumberFormatting').after(
                $('<div id="fbOptionDetailedLogging" class="optionsWindowOption"/>').click(
                        function() {
                            game.FrozenBattle.onToggleBoolSetting("detailedLogging")
                        }));
        $('#fbOptionDetailedLogging').after(
                $('<div id="fbOptionEnchanting" class="optionsWindowOption"/>').click(function() {
                    game.FrozenBattle.onToggleBoolSetting("enchantingEnabled")
                }));
        ...
        ondemandOptions
                .append($(
                        ...
                        .addClass('button').click(function() {
                            game.FrozenBattle.onToggleBoolSetting("autoCombatActive")
                        }));
        ...
        ondemandOptions.draggable({drag: function() { updateWindowDepths(document.getElementById("fbOnDemandOptions")); }});
        ...
        autoCombatLevelDifference
                ...
                .append(
                        $(
                                ...
                                .click(function() {
                                    game.FrozenBattle.onModifyBattleLevelDifference(-1);
                                }))
                .append(
        ...
        autoCombatLevel
                ...
                .append(
                        $(
                                ...
                                .click(function() {
                                    game.FrozenBattle.onModifyBattleLevel(-1);
                                }))
                .append(
        ...
        ondemandOptions.append($(
                ...
                .addClass('button').click(function() {
                    game.FrozenBattle.onToggleBoolSetting("autoSellActive")
                }));
        ...
        .addClass('button').click(function() {
            game.FrozenBattle.onIncreaseStat('statIncreaseStrength');
        }));
        
        ondemandOptions.append($(
        '<div id="statIncreaseSta" class="navBarText" style="padding: 2px 10px 2px 10px"/>')
        .addClass('button').click(function() {
            game.FrozenBattle.onIncreaseStat('statIncreaseStamina');
        }));
        
        ondemandOptions.append($(
        '<div id="statIncreaseAgi" class="navBarText" style="padding: 2px 10px 2px 10px"/>')
        .addClass('button').click(function() {
            game.FrozenBattle.onIncreaseStat('statIncreaseAgi');
        }));
        ...
        extraStats.draggable({drag: function() { updateWindowDepths(document.getElementById("fbExtraStatsWindow")); }});
    ...
    this.onSortInventory = function() {
        game.FrozenBattle.sortInventory();
    }
    
    this.onGamble = function() {
        game.FrozenBattle.gamble();
    }
    ...
    this.updateMercenarySalePrices = function() {
        ...
        $("#assassinCost").text(game.mercenaryManager.assassinPrice.formatNumber());
